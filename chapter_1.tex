...
W Polsce proporcje są nieco inne. Prowadzi również Android, ale według \cite{website:android:stat1} jego udział na rynku urządzeń mobilnych wynosi aż 63.8\%. Na~drugim miejscu plasuje się system Windows (15.7\%), a~system iOS jest na trzecim miejscu i~zajmuje około 10\% rynku urządzeń mobilnych (rysunek \ref{fig:android_udzial_polska}).
