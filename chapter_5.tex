...
Gdyby testów jednostkowych, tak jak w~badanym przypadku aplikacji w wersji pierwotnej nie było, wtedy potrzeba zwiększenia czasu przeznaczonego na testy integracyjne i~wyższego szczebla jest jeszcze większa, co pokazuje wykres \ref{fig:app_int_czas}.
